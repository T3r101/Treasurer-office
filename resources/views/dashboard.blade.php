        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-slate-400 font-medium text-sm">Real-time monitoring of city treasury activities and performance.</p>
                </div>
            ...
            <div class="bg-white/5 backdrop-blur-2xl rounded-3xl p-6 border border-white/10 shadow-2xl flex flex-wrap items-center justify-between gap-6 transition-all hover:bg-white/[0.08] ring-1 ring-white/5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h4 class="text-sm font-black text-white uppercase tracking-widest">Reports</h4>
                        <p class="text-slate-500 text-xs font-bold">Generate summaries and detailed statements</p>
                    </div>
                </div>
                <div class="flex items-center gap-3">
                    <a href="{{ route('summary.report.export', ['type' => 'pdf']) }}" class="flex items-center gap-2 px-5 py-2.5 bg-white/5 hover:bg-rose-500/10 border border-white/10 hover:border-rose-500/30 rounded-2xl text-xs font-black text-white uppercase tracking-widest transition-all hover:scale-105 active:scale-95">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gradient-to-br from-white/10 to-transparent backdrop-blur-xl rounded-3xl p-7 border border-white/10 shadow-2xl relative overflow-hidden group hover:shadow-cyan-500/20 transition-all duration-500 cursor-pointer hover:scale-[1.02] hover:-translate-y-1 ring-1 ring-white/5 hover:ring-cyan-500/30">
                    ...
                    <h3 class="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">Gross Volume</h3>
                    <p class="text-3xl font-black text-white tracking-tight group-hover:text-cyan-400 transition-colors">₱{{ number_format($totalTransactions, 2) }}</p>
                    <div class="mt-3 h-1 w-12 bg-cyan-500 rounded-full group-hover:w-24 transition-all duration-500"></div>
                </div>

                <!-- Total Income Card -->
                <div class="bg-gradient-to-br from-white/10 to-transparent backdrop-blur-xl rounded-3xl p-7 border border-white/10 shadow-2xl relative overflow-hidden group hover:shadow-emerald-500/20 transition-all duration-500 cursor-pointer hover:scale-[1.02] hover:-translate-y-1 ring-1 ring-white/5 hover:ring-emerald-500/30">
                    <div class="absolute top-0 right-0 p-4 opacity-10 text-emerald-600 group-hover:opacity-20 transition-opacity group-hover:scale-110">
                    ...
                    <h3 class="text-xs font-black text-emerald-600/70 uppercase tracking-widest mb-1">Total Income</h3>
                    <p class="text-3xl font-black text-white tracking-tight group-hover:text-emerald-400 transition-colors">₱{{ number_format($totalIncome, 2) }}</p>
                    <div class="mt-3 h-1 w-12 bg-emerald-500 rounded-full group-hover:w-24 transition-all duration-500"></div>
                </div>

                <!-- Total Expenses Card -->
                <div class="bg-gradient-to-br from-white/10 to-transparent backdrop-blur-xl rounded-3xl p-7 border border-white/10 shadow-2xl relative overflow-hidden group hover:shadow-rose-500/20 transition-all duration-500 cursor-pointer hover:scale-[1.02] hover:-translate-y-1 ring-1 ring-white/5 hover:ring-rose-500/30">
                    <div class="absolute top-0 right-0 p-4 opacity-10 text-rose-600 group-hover:opacity-20 transition-opacity group-hover:scale-110">
                    ...
                    <h3 class="text-xs font-black text-rose-600/70 uppercase tracking-widest mb-1">Total Expenses</h3>
                    <p class="text-3xl font-black text-white tracking-tight group-hover:text-rose-400 transition-colors">₱{{ number_format($totalExpenses, 2) }}</p>
                    <div class="mt-3 h-1 w-12 bg-rose-500 rounded-full group-hover:w-24 transition-all duration-500"></div>
                </div>

                <!-- Total Deposits Card -->
                <div class="bg-gradient-to-br from-white/10 to-transparent backdrop-blur-xl rounded-3xl p-7 border border-white/10 shadow-2xl relative overflow-hidden group hover:shadow-cyan-500/20 transition-all duration-500 cursor-pointer hover:scale-[1.02] hover:-translate-y-1 ring-1 ring-white/5 hover:ring-cyan-500/30">
                    <div class="absolute top-0 right-0 p-4 opacity-10 text-cyan-600 group-hover:opacity-20 transition-opacity group-hover:scale-110">
                    ...
                    <h3 class="text-xs font-black text-cyan-600/70 uppercase tracking-widest mb-1">Total Deposits</h3>
                    <p class="text-3xl font-black text-white tracking-tight group-hover:text-blue-400 transition-colors">₱{{ number_format($totalDeposits, 2) }}</p>
...
<!-- Monthly Revenue Chart -->
                <div class="lg:col-span-2 bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl relative overflow-hidden group">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            <h3 class="text-xl font-black text-white tracking-tight">Performance</h3>
                            <p class="text-slate-500 text-xs font-bold uppercase tracking-wider mt-1">Monthly trend analysis</p>
                        </div>
                ...
                <div class="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl flex flex-col">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h3 class="text-xl font-black text-white tracking-tight">Latest Actions</h3>
...
@forelse ($recentActivity as $activity)
                            <div class="group flex items-center gap-4 p-4 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/5 hover:border-white/10 transition-all duration-300 cursor-pointer">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex justify-between items-start">
                                        <p class="text-sm font-black text-slate-200 truncate group-hover:text-white transition-colors">{{ $activity->description }}</p>
                                        <p class="text-sm font-black {{ $activity->source_type === 'Deposit' ? 'text-emerald-400' : 'text-slate-200' }}">
    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    y: { grid: { display: true, color: 'rgba(255,255,255,0.05)' }, ticks: { color: '#64748b', font: { weight: 'bold' } } },
